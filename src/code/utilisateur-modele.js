import { authFirebase, authGoogle, bd, collUtilisateurs } from './init';
 ...
 *                                           l'état 'utilisateur'
 */
export function observerEtatConnexion(mutateurEtatUtilisateur, mutateurMessageErreur) {
...
export async function connexion() {
    await signInWithPopup(authFirebase, authGoogle);
}
...
function sauvegarderProfil(util) {
    ...
    setDoc(
        doc(bd, collUtilisateurs, util.uid), 
